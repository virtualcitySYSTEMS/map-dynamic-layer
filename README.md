...
| defaultSorting  | GeoNetwork         | `string`                | The default sorting of datasets                                                                                     | **'relevance'**, 'rating', 'popularity', 'lastModified', 'lastCreated', 'nameAsc'           |
| defaultSorting  | Piveau             | `string`                | The default sorting of datasets                                                                                     | **'relevance'**, 'nameAsc', 'nameDesc', 'lastModified', 'lastCreated'                       |
